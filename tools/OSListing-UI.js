...
make.setTarget(document.body);
$("atlas-fullscreen").addEventListener("click", () => alert("WIP"));
$("atlas-github").addEventListener("click", () => alert("WIP"));
$("atlas-License").addEventListener("click", () => alert("WIP"));
$("atlas-website").addEventListener("click", () => alert("WIP"));
